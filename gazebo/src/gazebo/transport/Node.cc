...
{
  gzlog << "Node::PrivateInit started, space '" << _space << "'\n";
  if (this->initialized)
  {
  ...
  gzlog << "Node::PrivateInit, topicNamespace = '" << this->topicNamespace << "'\n";

  TopicManager::Instance()->AddNode(shared_from_this());
  this->initialized = true;

  gzlog << "Node::PrivateInit, returns, namespace = '" << this->GetTopicNamespace() << "'\n";
  return true;
}
