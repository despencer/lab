  ...
  namespace transport
  {
      ...
      public boost::enable_shared_from_this<Connection>
    {
      ...
      public: template<typename Handler>
              ...
              {
                gzlog << "Connection::AsyncRead called, this=" << this <<"\n";
      ...
      private: template<typename Handler>
              ...
              {
                gzlog << "Connection::OnReadHeader called, this=" << this <<"\n";
                if (_e)
                {
      ...
      private: template<typename Handler>
               void OnReadData(const boost::system::error_code &_e,
                              boost::tuple<Handler> _handler)
              {
                gzlog << "Connection::OnReadData called, this=" << this << ", _e=" << _e << "\n";
                if (_e)
                {
                  if (_e.value() == boost::asio::error::eof)
                    this->isOpen = false;
                ...
                gzlog << "Connection::OnReadData called, this=" << this << ", inbound " << this->inboundData.size() << "\n";
                ...
                {
                  gzlog << "Connection::OnReadData called, this=" << this << ", ready to start a task\n";
#if TBB_VERSION_MAJOR < 2021
                  gzlog << "Connection::OnReadData run old\n";
...
#else
                  gzlog << "Connection::OnReadData run new\n";
